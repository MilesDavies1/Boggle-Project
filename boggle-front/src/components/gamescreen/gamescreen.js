...
import CorrectSoundFile from '../../assets/Correct_Answer_sound_effect.mp3';
import WrongSoundFile from '../../assets/Incorrect_sound_effect.mp3';
    ...
    return (
      <div className="App">
        ...
        <div className="Game-wrapper">
          <div>
            <h1>Points Earned: {this.state.points}</h1>
          </div>
          <div>
            <h3>
              <span>Timer: {this.state.timeInSec}{this.state.offline && <span> | Offline</span>}
              </span>
            </h3>
            {/* <h3>
